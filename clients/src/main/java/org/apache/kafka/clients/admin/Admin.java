...
public interface Admin extends AutoCloseable {
    ...
    /**
     * Get Ids of nodes for brokers and controllers in the cluster.
     *
     * @param options The options to use when getting node ids.
     * @return The DescribeNodeIdsResult.
     */
    DescribeNodeIdsResult describeNodeIds(DescribeNodeIdsOptions options);
