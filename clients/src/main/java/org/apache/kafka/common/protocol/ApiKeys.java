...
public enum ApiKeys {
    ...
    UPDATE_LICENSE(ApiMessageType.UPDATE_LICENSE, false, false),
    DESCRIBE_LICENSE(ApiMessageType.DESCRIBE_LICENSE, false, false),
    EXPORT_CLUSTER_MANIFEST(ApiMessageType.EXPORT_CLUSTER_MANIFEST, false, false),
