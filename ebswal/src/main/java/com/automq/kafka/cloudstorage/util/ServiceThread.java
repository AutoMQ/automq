 ...
 */
package com.automq.kafka.cloudstorage.util;

import com.automq.kafka.cloudstorage.util.CountDownLatch2;
...
public abstract class ServiceThread implements Runnable {
    private static final Logger log = LoggerFactory.getLogger("ServiceThread");
