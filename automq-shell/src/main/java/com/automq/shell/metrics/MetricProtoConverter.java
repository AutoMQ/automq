...
// *
// * <p>该工具类用于将 {@link io.opentelemetry.sdk.metrics.data.MetricData} 对象转换为符合
// * <a href="https://github.com/open-telemetry/opentelemetry-proto">OTLP/Protobuf</a> 规范的
// * {@link io.opentelemetry.proto.metrics.v1.ResourceMetrics} 对象，适用于需直接序列化/发送指标数据的场景。
// *
// * <h2>主要功能</h2>
// * <ul>
...
// * @see io.opentelemetry.proto.metrics.v1.ResourceMetrics Protobuf 数据结构
// */
...
//
//        for (Map.Entry<io.opentelemetry.sdk.common.InstrumentationScopeInfo, List<MetricData>> entry : grouped.entrySet()) {
...
//    }
//
//    private io.opentelemetry.proto.resource.v1.Resource convertResource(io.opentelemetry.sdk.resources.Resource  sdkResource) {
...
//    }
//
//    private InstrumentationScope convertInstrumentationScope(io.opentelemetry.sdk.common.InstrumentationScopeInfo scope) {
