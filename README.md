...
<p align="center">
  📑&nbsp <a
    href="https://www.automq.com/docs/automq/what-is-automq/overview?utm_source=github&utm_medium=automqrepo&utm_campaign=readme"
    target="_blank"
  ><b>Documentation</b></a>&nbsp&nbsp&nbsp
  🔥&nbsp <a
    href="https://www.automq.com/docs/automq-cloud/getting-started/install-byoc-environment/aws/install-env-from-marketplace?utm_source=github&utm_medium=automqrepo&utm_campaign=readme"
    target="_blank"
...
[![](https://img.shields.io/badge/AutoMQ%20vs.%20Kafka(Cost)-yellow)](https://www.automq.com/blog/automq-vs-apache-kafka-a-real-aws-cloud-bill-comparison?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
[![](https://img.shields.io/badge/AutoMQ%20vs.%20Kafka(Performance)-orange)](https://www.automq.com/docs/automq/benchmarks/automq-vs-apache-kafka-benchmarks-and-cost?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
...
- [JD.com x AutoMQ x CubeFS: A Cost-Effective Journey](https://www.automq.com/blog/jdcom-automq-cubefs-trillion-scale-kafka-messaging?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
- [Palmpay Uses AutoMQ to Replace Kafka, Optimizing Costs by 50%+](https://www.automq.com/blog/palmpay-uses-automq-to-replace-kafka?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
- [AutoMQ help Geely Auto(Fortune Global 500) solve the pain points of Kafka elasticity in the V2X scenario](https://www.automq.com/blog/automq-help-geely-auto-solve-the-pain-points-of-kafka-elasticity-in-the-v2x-scenario?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
- [How Asia’s Quora Zhihu uses AutoMQ to reduce Kafka cost and maintenance complexity](https://www.automq.com/blog/how-asias-quora-zhihu-use-automq-to-reduce-kafka-cost-and-maintenance-complexity?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
- [XPENG Motors Reduces Costs by 50%+ by Replacing Kafka with AutoMQ](https://www.automq.com/blog/xpeng-motors-reduces-costs-by-50-by-replacing-kafka-with-automq?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
- [Asia's GOAT, Poizon uses AutoMQ Kafka to build observability platform for massive data(30 GB/s)](https://www.automq.com/blog/asiax27s-goat-poizon-uses-automq-kafka-to-build-a-new-generation-observability-platform-for-massive-data?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
- [AutoMQ Helps CaoCao Mobility Address Kafka Scalability During Holidays](https://www.automq.com/blog/automq-helps-caocao-mobility-address-kafka-scalability-issues-during-mid-autumn-and-national-day?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
...
- [Deploy on Linux with 5 Nodes](https://www.automq.com/docs/automq/getting-started/cluster-deployment-on-linux?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
- [Deploy on Kubernetes](https://www.automq.com/docs/automq/getting-started/cluster-deployment-on-kubernetes?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
- [Run on Ceph / MinIO / CubeFS / HDFS](https://www.automq.com/docs/automq/deployment/overview?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
- [Try AutoMQ on AWS Marketplace (Two Weeks Free Trial)](https://docs.automq.com/automq-cloud/getting-started/install-byoc-environment/aws/install-env-from-marketplace?utm_source=github&utm_medium=automqrepo&utm_campaign=readme)
...
For more on AutoMQ's architecture, visit [AutoMQ Architecture](https://www.automq.com/docs/automq/architecture/overview?utm_source=github&utm_medium=automqrepo&utm_campaign=readme) or explore the source code directly.
...
The enterprise edition of AutoMQ offers a robust, user-friendly control plane for seamless cluster management, with enhanced availability and observability over the open-source version. Additionally, we offer [Kafka Linking](https://www.automq.com/solutions/kafka-linking?utm_source=github&utm_medium=automqrepo&utm_campaign=readme) for zero-downtime migration from any Kafka-compatible cluster to AutoMQ.

[Contact us](https://www.automq.com/contact?utm_source=github&utm_medium=automqrepo&utm_campaign=readme) for more information about the AutoMQ enterprise edition, and we'll gladly assist with your free trial.
