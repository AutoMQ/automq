...
public class QuorumControllerArchiveTest {
    ...
    private static QuorumControllerTestEnv controllerEnv(LocalLogManagerTestEnv logEnv, AutoMQVersion version)
        throws Exception {
        BootstrapMetadata bootstrap = BootstrapMetadata.fromVersions(MetadataVersion.latestTesting(),
            Map.of(AutoMQVersion.FEATURE_NAME, version.featureLevel()), "Archive batch test");
