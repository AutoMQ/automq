...
public class RouterChannelEpoch {
    ...
    public RouterChannelEpoch(long commited, long fenced, long current, long lastBumpUpTimestamp) {
    ...
    public boolean equals(Object o) {
        ...
        return commited == that.commited && fenced == that.fenced && current == that.current && lastBumpUpTimestamp == that.lastBumpUpTimestamp;
    }

    @Override
    public int hashCode() {
        return Objects.hash(commited, fenced, current, lastBumpUpTimestamp);
    }
    ...
    public static ByteBuf encode(RouterChannelEpoch routerChannelEpoch, short version) {
        ...
        record.put("commited", routerChannelEpoch.commited);
