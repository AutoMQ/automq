...
from kafkatest.automq.automq_e2e_util import (TOPIC, FILE_WAL, S3_WAL)
from kafkatest.services.console_consumer import ConsoleConsumer
from kafkatest.services.kafka import KafkaService
from kafkatest.services.verifiable_producer import VerifiableProducer
from kafkatest.tests.produce_consume_validate import ProduceConsumeValidateTest
from kafkatest.utils import is_int
from kafkatest.version import AUTOMQ_LATEST_1_1, DEV_BRANCH, KafkaVersion, \
    LATEST_STABLE_METADATA_VERSION, LATEST_STABLE_FEATURE_VERSION
...
class TestUpgrade(ProduceConsumeValidateTest):
    ...
    def create_kafka(self, num_nodes=3, partition=3, replication_factor=3, broker_wal='file', env=None, project_name=None, version=DEV_BRANCH):
        """
