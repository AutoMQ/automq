...
class ConnectStandaloneFileTest(Test):
    ...
    @cluster(num_nodes=5)
    @parametrize(error_tolerance=ErrorTolerance.ALL, metadata_quorum=quorum.combined_kraft)
    ...
    @parametrize(error_tolerance=ErrorTolerance.NONE, metadata_quorum=quorum.combined_kraft)
