...
class ConnectStandaloneFileTest(Test):
    ...
    @cluster(num_nodes=5)
<<<<<<< HEAD
    @parametrize(error_tolerance=ErrorTolerance.ALL, metadata_quorum=quorum.colocated_kraft)
    ...
    @parametrize(error_tolerance=ErrorTolerance.NONE, metadata_quorum=quorum.colocated_kraft)
=======
