...
class ElasticReplicaManager(override val config: KafkaConfig,
  metrics: Metrics,
  time: Time,
  scheduler: Scheduler,
  override val logManager: LogManager,
  override val remoteLogManager: Option[RemoteLogManager] = None,
  quotaManagers: QuotaManagers,
  override val metadataCache: MetadataCache,
  logDirFailureChannel: LogDirFailureChannel,
  override val alterPartitionManager: AlterPartitionManager,
  override val brokerTopicStats: BrokerTopicStats = new BrokerTopicStats(),
  override val isShuttingDown: AtomicBoolean = new AtomicBoolean(false),
  override val zkClient: Option[KafkaZkClient] = None,
  ...
  override val brokerEpochSupplier: () => Long = () => -1,
  addPartitionsToTxnManager: Option[AddPartitionsToTxnManager] = None,
  override val directoryEventHandler: DirectoryEventHandler = DirectoryEventHandler.NOOP
