...
object Defaults {
  ...
  val S3ObjectCompactionMaxStreamNumInWAL: Int = 10000
  val S3ObjectCompactionMaxStreamObjectNum: Int = 10000
...
object KafkaConfig {
  ...
  val S3ObjectCompactionMaxStreamNumInWAL = "s3.object.compaction.max.stream.num"
  val S3ObjectCompactionMaxStreamObjectNum = "s3.object.compaction.max.stream.object.num"
  ...
  val S3ObjectCompactionMaxStreamNumInWALDoc = "The maximum number of streams allowed in the WAL object generated by compaction"
  val S3ObjectCompactionMaxStreamObjectNumDoc = "The maximum number of stream objects in single compaction"
  ...
  private[server] val configDef = {
    ...
    // elastic stream inject start
      ...
      .define(S3ObjectCompactionMaxStreamNumInWAL, INT, Defaults.S3ObjectCompactionMaxStreamNumInWAL, MEDIUM, S3ObjectCompactionMaxStreamNumInWALDoc)
      .define(S3ObjectCompactionMaxStreamObjectNum, INT, Defaults.S3ObjectCompactionMaxStreamObjectNum, MEDIUM, S3ObjectCompactionMaxStreamObjectNumDoc)
...
class KafkaConfig private(doLog: Boolean, val props: java.util.Map[_, _], dynamicConfigOverride: Option[DynamicBrokerConfig])
  ...
  val s3ObjectCompactionMaxStreamNumInWAL = getInt(KafkaConfig.S3ObjectCompactionMaxStreamNumInWAL)
  val s3ObjectCompactionMaxStreamObjectNum = getInt(KafkaConfig.S3ObjectCompactionMaxStreamObjectNum)
