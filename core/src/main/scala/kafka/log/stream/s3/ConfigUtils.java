...
public class ConfigUtils {
    ...
    public static Config to(KafkaConfig s) {
        return new Config()
                ...
                .walUploadThreshold(s.s3WALObjectSize())
                ...
                .sstCompactionInterval(s.s3WALObjectCompactionInterval())
                .sstCompactionCacheSize(s.s3WALObjectCompactionCacheSize())
                .sstCompactionUploadConcurrency(s.s3WALObjectCompactionUploadConcurrency())
                .maxStreamNumPerSST(s.s3MaxStreamNumPerWALObject())
                .maxStreamObjectNumPerCommit(s.s3MaxStreamObjectNumPerCommit())
                .sstCompactionStreamSplitSize(s.s3WALObjectCompactionStreamSplitSize())
                .sstCompactionForceSplitPeriod(s.s3WALObjectCompactionForceSplitPeriod())
                .sstCompactionMaxObjectNum(s.s3WALObjectCompactionMaxObjectNum())
