...
public class ConfigUtils {
    ...
    public static Config to(KafkaConfig s) {
        return new Config()
                ...
                .streamSetObjectCompactionInterval(s.s3SSTCompactionInterval())
                .streamSetObjectCompactionCacheSize(s.s3SSTCompactionCacheSize())
                .maxStreamNumPerStreamSetObject(s.s3MaxStreamNumPerSST())
                .maxStreamObjectNumPerCommit(s.s3MaxStreamObjectNumPerCommit())
                .streamSetObjectCompactionStreamSplitSize(s.s3SSTCompactionStreamSplitSize())
                .streamSetObjectCompactionForceSplitPeriod(s.s3SSTCompactionForceSplitMinutes())
                .streamSetObjectCompactionMaxObjectNum(s.s3SSTCompactionMaxObjectNum())
