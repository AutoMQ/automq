...
import kafka.log.stream.s3.objects.CommitStreamObjectRequest;
import kafka.log.stream.s3.objects.ObjectManager;
import kafka.log.stream.s3.operator.S3Operator;
import kafka.log.stream.s3.operator.Writer;
...
public class StreamObjectsCompactionTask {
    ...
    public StreamObjectsCompactionTask(ObjectManager objectManager, S3Operator s3Operator, S3Stream stream,
        ...
        this.stream = stream;
        this.compactedStreamObjectMaxSizeInBytes = Utils.min(compactedStreamObjectMaxSizeInBytes, Writer.MAX_OBJECT_SIZE);
