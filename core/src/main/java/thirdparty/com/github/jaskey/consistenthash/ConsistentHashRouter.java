 ...
 */
package thirdparty.com.github.jaskey.consistenthash;
...
public class ConsistentHashRouter<T extends Node> {
    ...
    public void removeNode(T pNode) {
        Iterator<Map.Entry<Long, VirtualNode<T>>> it = ring.entrySet().iterator();
        while (it.hasNext()) {
            Map.Entry<Long, VirtualNode<T>> entry = it.next();
            VirtualNode<T> virtualNode = entry.getValue();
