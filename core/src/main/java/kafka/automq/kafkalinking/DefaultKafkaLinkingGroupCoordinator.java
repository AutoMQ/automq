...
public class DefaultKafkaLinkingGroupCoordinator extends KafkaLinkingGroupCoordinator {
    ...
    @Override
    public CompletableFuture<AutomqUpdateGroupsResponseData> updateGroups(
        RequestContext context,
        AutomqUpdateGroupsRequestData request,
        BufferSupplier bufferSupplier) {
        return FutureUtils.failedFuture(new UnsupportedOperationException(ApiKeys.AUTOMQ_UPDATE_GROUPS.name() + " is not supported"));
    }
