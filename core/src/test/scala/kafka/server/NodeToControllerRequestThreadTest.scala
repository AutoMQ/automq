...
<<<<<<< HEAD:core/src/test/scala/kafka/server/BrokerToControllerRequestThreadTest.scala
    val testRequestThread = new BrokerToControllerRequestThread(
=======
    val testRequestThread = new NodeToControllerRequestThread(
>>>>>>> trunk:core/src/test/scala/kafka/server/NodeToControllerRequestThreadTest.scala
