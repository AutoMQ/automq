@echo off
REM Quick Start Script for IoT Burst Resilience Pilot
REM Run this from the iot-resilience-pilot directory
...
REM Step 2: Create topic
echo.
echo [3/4] Creating Kafka topic...
docker-compose exec automq /opt/automq/kafka/bin/kafka-topics.sh --create --topic iot_telemetry --bootstrap-server localhost:9092 --partitions 3 --replication-factor 1 2>nul
if %errorlevel% neq 0 (
