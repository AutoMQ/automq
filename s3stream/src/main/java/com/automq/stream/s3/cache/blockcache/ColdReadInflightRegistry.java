...
public final class ColdReadInflightRegistry {
    ...
    /**
     * Removes a completed cold read future from the in-flight registry.
     */
    public static void untrack(CompletableFuture<?> future) {
        TRACKER.untrack(future);
    }
    ...
    /**
     * Returns the current number of in-flight cold reads.
     */
    public static int pendingCount() {
        return TRACKER.pendingCount();
    }
